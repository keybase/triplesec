...
test_xor = (T, d) ->
  ...
  m3 = (new hmac.HMAC d.key, KECCAK).update(new WordArray [1]).finalize(d.msg)
  m5.xor m3, {}
  T.equal m5.to_hex(), x1.to_hex(), "XOR works"
  x2 = (new XOR d.key, [ KECCAK, SHA512]).finalize d.msg
