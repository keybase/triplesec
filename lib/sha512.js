...
(function() {
  ...
  Global = (function() {
    Global.prototype.convert = function(raw) {
      ...
      _results = [];
      for (i = _i = 0, _len = raw.length; _i < _len; i = ++_i) {
        v = raw[i];
        _results.push(new X64Word(v, raw[i + 1]));
      }
      return _results;
    };
    ...
    function Global() {
      ...
      this.I = this.convert([0x6a09e667, 0xf3bcc908, 0xbb67ae85, 0x84caa73b, 0x3c6ef372, 0xfe94f82b, 0xa54ff53a, 0x5f1d36f1, 0x510e527f, 0xade682d1, 0x9b05688c, 0x2b3e6c1f, 0x1f83d9ab, 0xfb41bd6b, 0x5be0cd19, 0x137e2179]);
      this.W = new X64WordArray((function() {
        var _i, _results;
        _results = [];
  ...
  exports.SHA521 = SHA512 = (function(_super) {
