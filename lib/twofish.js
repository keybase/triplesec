...
(function() {
  ...
  Global = (function() {
    function Global() {
      ...
      this.GF256_FDBK_2 = GF256_FDBK / 2;
      this.GF256_FDBK_4 = GF256_FDBK / 4;
  ...
  exports.TwoFish = TwoFish = (function() {
    function TwoFish() {
      this.gMDS0 = [];
      this.gMDS1 = [];
      this.gMDS2 = [];
    ...
    TwoFish.prototype.F32 = function(x, k32) {
      ...
      switch (this.k64Cnt & 3) {
        case 1:
          result = this.gMDS0[(G.P[G.P_01][b0] & 0xff) ^ this.getByte(k0, 0)] ^ this.gMDS1[(G.P[G.P_11][b1] & 0xff) ^ this.getByte(k0, 1)] ^ this.gMDS2[(G.P[G.P_21][b2] & 0xff) ^ this.getByte(k0, 2)] ^ this.gMDS3[(G.P[G.P_31][b3] & 0xff) ^ this.getByte(k0, 3)];
          break;
        case 0:
    ...
    TwoFish.prototype._doReset = function() {
      var A, B, b0, b1, b2, b3, i, j, k0, k1, k2, k3, k32e, k32o, m1, mX, mY, p, q, sBoxKeys, _i, _j, _k, _ref, _ref1, _results;
      k32e = [];
      k32o = [];
      sBoxKeys = [];
      m1 = [];
      ...
      for (i = _i = 0; _i < 256; i = ++_i) {
        ...
        for (i = _j = 0, _ref = this.k64Cnt; 0 <= _ref ? _j < _ref : _j > _ref; i = 0 <= _ref ? ++_j : --_j) {
          ...
          sBoxKeys[this.k64Cnt - 1 - i] = G.RS_MDS_Encode(k32e[i], k32o[i]);
        }
          ...
          for (i = _l = 0; _l < 256; i = ++_l) {
            ...
            switch (this.k64Cnt & 3) {
              case 1:
                ...
                this.gSBox[i * 2 + 0x201] = this.gMDS3[(G.P[G.P_31][b3] & 0xff) ^ this.getByte(k0, 3)];
                break;
              case 0:
                b0 = (G.P[G.P_04][b0] & 0xff) ^ this.getByte(k3, 0);
                b1 = (G.P[G.P_14][b1] & 0xff) ^ this.getByte(k3, 1);
            ...
            if ((this.k64Cnt & 3) !== 1) {
              ...
              _results1.push(this.gSBox[i * 2 + 0x201] = this.gMDS3[(G.P[G.P_31][(G.P[G.P_32][b3] & 0xff) ^ this.getByte(k1, 3)] & 0xff) ^ this.getByte(k0, 3)]);
            } else {
