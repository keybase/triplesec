...
(function() {
  var Cipher, Counter, Salsa20, Salsa20Core, Salsa20WordArray, StreamCipher, WordArray, asum, encrypt, endian_reverse, fixup_uint32, _ref, _ref1,
  ...
  Salsa20Core = (function() {
    ...
    Salsa20Core.prototype.block_size = 64;
  ...
  exports.Salsa20WordArray = Salsa20WordArray = (function(_super) {
    __extends(Salsa20WordArray, _super);

    function Salsa20WordArray() {
      _ref = Salsa20WordArray.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Salsa20WordArray.prototype._reset = function() {
      return Salsa20WordArray.__super__._reset.call(this);
    };

    Salsa20WordArray.prototype.getWordArray = function(nbytes) {
      var blocks, i, nblocks, w, words, _i, _len, _ref1;
      if ((nbytes == null) || nbytes === this.block_size) {
        words = this._generateBlock();
      } else {
        nblocks = Math.ceil(nbytes / this.block_size);
        blocks = (function() {
          var _i, _results;
          _results = [];
  ...
  exports.Salsa20 = Salsa20 = (function(_super) {
    ...
    Salsa20.prototype._generateBlockBuffer = function() {
      var e, i, v, _i, _len;
      this._buf = new Buffer(this.block_size);
  ...
  exports.Cipher = Cipher = (function(_super) {
    ...
    function Cipher(_arg) {
      ...
      this.salsa = new Salsa20(key, iv);
      this.bsiw = this.salsa.block_size / 4;
    }
