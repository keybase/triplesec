...
(function() {
  var Cipher, Counter, Salsa20, Salsa20Core, Salsa20WordArray, WordArray, asum, endian_reverse, fixup_uint32, _ref, _ref1,
  ...
  exports.Salsa20WordArray = Salsa20WordArray = (function(_super) {
    ...
    Salsa20WordArray.prototype.getWordArray = function(nbytes) {
      var blocks, i, nblocks, words, _ref1;
      ...
      blocks = (function() {
        ...
        for (i = _i = 0; 0 <= nblocks ? _i < nblocks : _i > nblocks; i = 0 <= nblocks ? ++_i : --_i) {
          _results.push((function() {
            ...
            _ref1 = this._generateBlock();
            _results1 = [];
            for (_j = 0, _len = _ref1.length; _j < _len; _j++) {
              i = _ref1[_j];
              _results1.push(endian_reverse(i));
            }
            return _results1;
          }).call(this));
        }
