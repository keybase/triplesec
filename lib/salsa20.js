...
(function() {
  var Cipher, Counter, Salsa20, WordArray, asum, endian_reverse, fixup_uint32;
  ...
  exports.Salsa20 = Salsa20 = (function() {
    ...
    Salsa20.prototype.getBytes = function(needed) {
      ...
      if ((this._i === bsz) && (needed === bsz)) {
        return this._generateBufferBlock();
      } else {
        while (needed > 0) {
          if (this._i === bsz) {
            this._generateBufferBlock();
            this._i = 0;
          }
          n = Math.min(needed, bsz - this._i);
          v.push((n === bsz ? this._bufblock : this._bufblock.slice(this._i, this._i + n)));
          this._i += n;
          needed -= n;
        }
    ...
    Salsa20.prototype._generateBufferBlock = function() {
      var e, i, v, _i, _len;
      this._bufblock = new Buffer(this.block_size);
      v = this._generateBlock();
      for (i = _i = 0, _len = v.length; _i < _len; i = ++_i) {
        e = v[i];
        this._bufblock.writeUInt32LE(fixup_uint32(e), i * 4);
      }
      return this._bufblock;
    };
