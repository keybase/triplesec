  ...
  exports.Salsa20 = Salsa20 = (function() {
    ...
    function Salsa20(key, nonce) {
      ...
      if (!(((this.key.sigBytes === 16) && (this.nonce.sigBytes === 8)) || ((this.key.sigBytes === 32) && ((_ref = this.nonce.sigBytes) === 8 || _ref === 24)))) {
        throw new Error("Bad key/none lengths");
      }
    ...
    Salsa20.prototype.nonce_setup = function() {
      this.key = this.hsalsa20(this.nonce.words.slice(0, 4), this.key);
      return this.nonce = new WordArray(this.nonce.words.slice(4));
    };
