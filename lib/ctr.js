...
(function() {
  var Cipher, Counter, KeyStream, WordArray;
  ...
  KeyStream = (function() {
    function KeyStream(_arg) {
      ...
      if (!(this.iv.length === this.block_cipher.blockSize)) {
  ...
  exports.Cipher = Cipher = (function() {
    function Cipher(_arg) {
      ...
      if (!(this.seed.length === this.block_cipher.blockSize)) {
        throw new Error("IV is wrong length");
      }
    ...
    Cipher.prototype.encryptBlock = function(word_array, dst_offset) {
      ...
      pad = this.ctr.inc().copy();
      this.block_cipher.encryptBlock(pad.words);
      n_words = Math.min(word_array.words.length - offset, this.bsiw);
      word_array.xor(pad, {
