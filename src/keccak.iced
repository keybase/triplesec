...
#  
exports.KECCAK = class KECCAK extends Hasher

  @outputLength : 512                            # in bits!
  outputLength : KECCAK.outputLength               # in bits
  @blockSize : (1600 - 2 * KECCAK.outputLength)/32 # in # of 32-bit words
  blockSize : KECCAK.blockSize                     # in # of 32-bit words
