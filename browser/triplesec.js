...
// Generated by IcedCoffeeScript 1.6.3-f
(function() {
  var BlockCipher, BufferedBlockAlgorithm, Hasher, StreamCipher, WordArray,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  exports.StreamCipher = StreamCipher = (function() {
    ...
    StreamCipher.prototype.encrypt = function(word_array) {
      ...
      for (i = _i = 0, _ref = word_array.words.length, _ref1 = this.bsiw; _ref1 > 0 ? _i < _ref : _i > _ref; i = _i += _ref1) {
        _results.push(this.encryptBlock(word_array, i));
      }
      return _results;
    };
...
},{"./wordarray":14}],3:[function(require,module,exports){
// Generated by IcedCoffeeScript 1.6.3-f
(function() {
  var Cipher, Counter, KeyStream, StreamCipher, WordArray, encrypt, iced, __iced_k, __iced_k_noop,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  exports.encrypt = encrypt = function(_arg, cb) {
    ...
    (function(__iced_k) {
      ...
      cipher.encrypt(input, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
...
(function() {
  ...
  exports.Encryptor = Encryptor = (function(_super) {
    ...
    Encryptor.prototype.resalt = function() {
      ...
      this.pbkdf2(this.salt, __iced_deferrals.defer({
...
(function() {
  ...
  exports.bulk_sign = function(_arg, async_args) {
    ...
    return util.bulk(input, slice_args, async_args);
  };
...
var Buffer=require("__browserify_Buffer").Buffer;// Generated by IcedCoffeeScript 1.6.3-f
(function() {
  var Cipher, Counter, Salsa20, Salsa20Core, Salsa20WordStream, StreamCipher, WordArray, asum, encrypt, endian_reverse, fixup_uint32, util, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  exports.Cipher = Cipher = (function(_super) {
    ...
    Cipher.prototype.get_pad = function() {
      return this.salsa.getWordArray();
    };
...
},{"./algbase":2,"./ctr":3,"./util":13,"./wordarray":14,"__browserify_Buffer":26}],11:[function(require,module,exports){
// Generated by IcedCoffeeScript 1.6.3-f
(function() {
...
(function() {
  ...
  exports.bulk = function(_arg, _arg1) {
