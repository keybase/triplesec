...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.pbkdf2 = function(_arg, cb) {
      var arg, end, i, k, keys, len, lens, progress_hook, raw, salt, salt_hex, tot, v, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        if ((keys = _this.derived_keys[salt_hex]) == null) {
          ...
          (function(__iced_k) {
            ...
            pbkdf2(arg, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
  ...
  exports.Encryptor = Encryptor = (function(_super) {
    ...
    Encryptor.prototype.pick_random_ivs = function(_arg, cb) {
      var iv_lens, ivs, k, progress_hook, v;
      progress_hook = _arg.progress_hook;
      iv_lens = {
        aes: AES.ivSize,
        ...
        _while = function(__iced_k) {
          ...
          if (!(i < _this.c)) {
            ...
            (function(__iced_k) {
              ...
              util.default_delay(__iced_deferrals.defer({
                lineno: 40
              }));
              __iced_deferrals._fulfill();
            })(_next);
...
},{"./hmac":6,"./util":13,"./wordarray":14,"iced-coffee-script/lib/coffee-script/iced":28}],9:[function(require,module,exports){
var Buffer=require("__browserify_Buffer").Buffer;// Generated by IcedCoffeeScript 1.6.3-f
(function() {
