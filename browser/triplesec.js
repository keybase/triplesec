      ...
      slice_args = {
        update: function(lo, hi) {
          ...
          for (i = _i = lo, _ref = _this.bsiw; _ref > 0 ? _i < hi : _i > hi; i = _i += _ref) {
            _results.push(_this.encryptBlock(word_array, i));
          }
          return _results;
        },
        finalize: function() {
...
(function() {
  ...
  exports.Decryptor = Decryptor = (function(_super) {
    ...
    Decryptor.prototype.generate_keys = function(cb) {
      var keys, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(__iced_k) {
    ...
    Decryptor.prototype.run = function(data, cb) {
      var ct1, ct2, esc, iv, pt, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            _this.generate_keys(__iced_deferrals.defer({
  ...
  exports.decrypt = decrypt = function(_arg, cb) {
    var data, dec, err, key, pt, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    (function(__iced_k) {
      ...
      dec.run(data, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            err = arguments[0];
...
},{"./aes":1,"./ctr":3,"./enc":5,"./hmac":6,"./pbkdf2":8,"./salsa20":10,"./sha512":11,"./twofish":12,"./wordarray":14,"iced-coffee-script/lib/coffee-script/iced":28,"iced-error":29}],5:[function(require,module,exports){
// Generated by IcedCoffeeScript 1.6.3-f
(function() {
...
(function() {
  ...
  exports.default_delay = default_delay = function(i, n, cb) {
    ...
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    console.log("Start setTimeout(2)");
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
