...
(function() {
  ...
  Base = (function() {
    function Base(_arg) {
      var key;
      key = _arg.key, this.version = _arg.version;
      this.key = WordArray.from_buffer(key);
      this.version || (this.version = V[1]);
      this.derived_keys = {};
    }
      ...
      (function(__iced_k) {
        if ((keys = _this.derived_keys[salt_hex]) == null) {
          ...
          (function(__iced_k) {
            ...
            keys.extra = raw.words.slice(end);
  ...
  Encryptor = (function(_super) {
    ...
    Encryptor.prototype.resalt = function(_arg, cb) {
      var extra_keymaterial, progress_hook, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      extra_keymaterial = _arg.extra_keymaterial, progress_hook = _arg.progress_hook;
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/enc.iced",
    ...
    Encryptor.prototype.run = function(_arg, cb) {
      var ct1, ct2, ct3, data, esc, extra_keymaterial, ivs, progress_hook, pt, ret, sig, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      data = _arg.data, extra_keymaterial = _arg.extra_keymaterial, progress_hook = _arg.progress_hook;
