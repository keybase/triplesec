...
(function() {
  ...
  XOR = (function(_super) {
    ...
    XOR.get_output_size = function() {
      return Math.min(SHA512.output_size, SHA3.output_size);
    };
    ...
    XOR.bulk_sign = function(args, cb) {
      args.klass = XOR;
      args.what = "hmac-sha512-xor-sha3";
      return bulk_sign(args, cb);
    };
...
// Generated by IcedCoffeeScript 1.6.3-f
(function() {
  var AES, Base, Concat, Encryptor, SHA512, TwoFish, V, WordArray, XOR, ctr, iced, pbkdf2, prng, salsa20, util, __iced_k, __iced_k_noop, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
